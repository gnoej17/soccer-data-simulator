...
pygame.display.set_caption("Data-Driven 3v3 Soccer Simulator (v15 - Animated Penalties)")

# COLORS
GREEN = (34, 139, 34); WHITE = (255, 255, 255); BLUE = (0, 0, 255); RED = (255, 0, 0); BLACK = (0, 0, 0); GOLD = (255, 215, 0); ORANGE = (255, 165, 0); YELLOW = (255, 255, 0)
GRAY = (100, 100, 100); DARK_GREEN = (0, 80, 0) # Darker grass for penalty mode
...
# <<<<<<< NEW: ANIMATED PENALTY SHOOTOUT (VISUAL OVERHAUL) >>>>>>>
def handle_penalty_shootout_state(events, keys, game_objects, penalty_data):
    ...
    if 'anim_state' not in penalty_data:
        penalty_data['anim_state'] = 'aiming' # aiming, running, kicking, result_display
            ...
            if penalty_data['user_dir'] is None:
                ...
                for event in events:
                    if event.type == pygame.KEYUP and event.key == pygame.K_SPACE:
                        ...
                        penalty_data['anim_state'] = 'running' # Start Animation sequence
